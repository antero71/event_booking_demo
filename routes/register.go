...
func registerForEvent(context *gin.Context) {
	...
	if err != nil {
		context.JSON(http.StatusInternalServerError, gin.H{"message": "Could not register user.", "details": err.Error()})
	}
...
func cancelRegistration(context *gin.Context) {
	...
	if err != nil {
		context.JSON(http.StatusInternalServerError, gin.H{"message": "Could not cancel registration.", "details": err.Error()})
		return
	}
